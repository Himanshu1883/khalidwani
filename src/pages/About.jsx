    ...
    <div className="min-h-screen bg-[#06070a] overflow-x-hidden">
          ...
          >
            ...
            <div className="space-y-6">
              <motion.div variants={fadeInUp}>
                ...
                >
                  ...
                  guided by a
                  <br />
                  <em className="italic text-[#B0E4CC] not-italic">higher purpose.</em>
                </h1>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="hidden md:flex items-center gap-6 pt-6">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="text-gray-400 hover:text-[#B0E4CC] transition-colors duration-300"
                  >
            ...
            >
              <div className="relative w-full max-w-2xl mx-auto group">
                ...
                <div className="absolute inset-0 rounded-full bg-[#B0E4CC]/5 blur-2xl scale-110 group-hover:scale-125 transition-transform duration-700"></div>
                ...
                <div className="relative rounded-full overflow-hidden shadow-xl">
                  <img
                    ...
                    className="w-full h-auto rounded-full object-cover object-[center_20%] aspect-square transform transition-transform duration-700 group-hover:scale-105"
                    onError={(e) => {
                      e.target.src =
                ...
                {/* Minimalist Frame */}
                <div className="absolute inset-0 rounded-full border border-[#B0E4CC]/30 pointer-events-none group-hover:border-[#B0E4CC]/60 transition-colors duration-300"></div>

                {/* Subtle Accent */}
                <div className="absolute -bottom-3 -right-3 w-24 h-24 rounded-full bg-[#B0E4CC]/5 blur-xl -z-10"></div>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <stat.icon className="text-[#B0E4CC] text-3xl md:text-4xl mx-auto mb-4 opacity-70 group-hover:opacity-100 transition-opacity" />
                <div className="text-[#B0E4CC] font-cormorant text-5xl md:text-6xl font-light mb-2">
                  {stat.number}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-px bg-[#B0E4CC]" />
                <span className="text-[#B0E4CC] font-inter text-[10px] tracking-[0.2em] uppercase">Impact & Legacy</span>
              </div>
              <h2 className="text-white font-cormorant text-4xl md:text-5xl font-light leading-tight">
                The Power of
                <br />
                <span className="text-[#B0E4CC]">Giving Back</span>
              </h2>
              <p className="text-gray-300 font-inter text-base leading-relaxed font-light">
      ...
      <section className="relative bg-[#111111] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-28">
          <div className="flex flex-col lg:flex-row items-start gap-0">
            ...
            <div className="w-full lg:w-[52%] lg:pr-12">
              ...
              >
                <div className="w-7 h-px bg-[#B0E4CC]" />
                <p className="text-[#B0E4CC] font-inter text-[10px] tracking-[0.24em] uppercase font-medium">
                  Excellence Defined
                </p>
              </motion.div>
                ...
                {achievements.map((achievement, index) => (
                  <motion.div
                    ...
                    className="group flex items-start gap-5 py-5 border-b border-white/[0.07]
                               hover:border-[#B0E4CC]/30 transition-colors duration-300 cursor-default"
                  >
                    {/* Index + icon */}
                    <div className="flex-shrink-0 flex flex-col items-center gap-1.5 pt-0.5 w-9">
                      <span
                        className="font-cormorant font-light leading-none
                                   text-[#B0E4CC]/35 group-hover:text-[#B0E4CC]/80
                      ...
                      <div
                        className="w-8 h-8 rounded-lg border border-[#B0E4CC]/20
                                   flex items-center justify-center
                                   group-hover:border-[#B0E4CC]/55
                                   group-hover:bg-[#B0E4CC]/[0.08]
                                   transition-all duration-300"
                      >
                        <achievement.icon
                          className="text-[#B0E4CC] opacity-55
                    ...
                    <div className="flex-1 min-w-0">
                      <h3
                        className="text-white font-cormorant font-light tracking-wide
                                   group-hover:text-[#B0E4CC] transition-colors duration-300
                                   leading-tight mb-1"
                    ...
                    {/* Hover arrow */}
                    <div
                      className="flex-shrink-0 self-center text-[#B0E4CC]
        ...
        >
          ...
          >
            ...
            <p className="text-[#B0E4CC] font-inter text-[9px] tracking-[0.2em] uppercase font-medium mt-2">
              — Shri Khalid Wani
            </p>
          </div>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-[#111111] rounded-2xl p-8 border border-[#B0E4CC]/10 relative group">
                <FaQuoteLeft className="text-[#B0E4CC] text-2xl mb-4 opacity-50" />
                ...
                <div className="mt-6 pt-4 border-t border-[#B0E4CC]/10 flex items-center justify-between">
                  <p className="text-[#B0E4CC] font-cormorant text-sm tracking-wide">
                    - Khalid Wani
                  </p>
      ...
      <section className="py-24 px-4 md:px-8 lg:px-16 bg-[#111111]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="w-12 h-px bg-[#B0E4CC] mx-auto" />
            ...
            <p className="text-white font-inter text-base leading-relaxed font-light border-l-2 border-[#B0E4CC] pl-6 mx-auto max-w-2xl">
      ...
      <section className="py-24 px-4 md:px-8 lg:px-16">
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="max-w-5xl mx-auto bg-gradient-to-r from-[#B0E4CC]/5 to-[#06070a] border border-[#B0E4CC]/20 rounded-2xl p-8 md:p-12 text-center"
        >
          <FaEnvelope className="text-[#B0E4CC] text-4xl mx-auto mb-6 opacity-70" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-[#B0E4CC] text-[#06070a] font-inter text-[10px] font-medium tracking-[0.2em] uppercase rounded hover:bg-[#B0E4CC]/90 transition-all duration-300 transform hover:scale-105"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-[#B0E4CC]/40 text-[#B0E4CC] font-inter text-[10px] font-medium tracking-[0.2em] uppercase rounded hover:border-[#B0E4CC] hover:bg-[#B0E4CC]/5 transition-all duration-300"
            >
              <FaExternalLinkAlt className="text-sm" />
              Visit Website
            </a>
          </div>
          <div className="mt-8 pt-6 border-t border-[#B0E4CC]/10">
