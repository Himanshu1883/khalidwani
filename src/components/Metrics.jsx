...
export default function Metrics() {
  ...
  return (
    <section
      id="results"
      className="px-8 md:px-16 py-28 grid md:grid-cols-2 gap-16 md:gap-24 items-center"
    >
      {/* Text */}
      <div className="reveal-left">
        ...
        <p className="text-sm font-light leading-[1.9] text-muted mb-10 hover:text-gold transition-colors duration-200">
