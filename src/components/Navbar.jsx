...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <a
        href="#"
        className="font-cormorant text-xl tracking-widest text-cream no-underline hover:text-gold transition-colors duration-300"
      ...
      {/* Mobile menu */}
      <div className={`fixed inset-0 bg-ink/98 backdrop-blur-xl md:hidden transition-all duration-500 flex items-center justify-center ${
