      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="mb-14 flex flex-col gap-8 lg:mb-16 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="reveal-right delay-1 max-w-2xl lg:text-right">
            ...
            <a
              href="#contact"
              className="mt-6 inline-flex h-14 items-center justify-center rounded-full bg-gold px-8 text-[10px] font-bold uppercase tracking-[0.24em] text-[#07111f] transition duration-300 hover:-translate-y-0.5 hover:bg-gold-light"
            >
              Book Consultation
            </a>
          </div>
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-between p-6 md:p-7">
        <div className="flex items-start justify-between gap-4">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-white/15 bg-white/[0.04] text-sm text-gold backdrop-blur-xl">
            {service.icon}
          </div>
        ...
        <div className="max-w-[62%]">
          <p className="mb-3 text-[10px] font-semibold uppercase tracking-[0.26em] text-[#65a9ff]">
            Signature Service
          </p>
