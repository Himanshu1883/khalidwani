...
export default function About() {
  return (
    <section
      id="about"
      className="px-8 md:px-16 py-32 grid md:grid-cols-2 gap-16 md:gap-24 items-center"
    >
      {/* Text */}
      <div className="reveal-left">
        ...
        <p className="text-sm font-light leading-[1.95] text-muted mb-5 hover:text-gold transition-colors duration-200">
          ...
          foundation for the remarkable leader he is today — navigating complex
          industries and reshaping India's entrepreneurial landscape.
        </p>
        <p className="text-sm font-light leading-[1.95] text-muted mb-5 hover:text-gold transition-colors duration-200">
          He has delivered 100+ speaking sessions, reached 30M+ viewers through
          All India Radio and Doordarshan, invested in 50+ companies, and
          mentored over 10,000 entrepreneurs. His 200K+ social following
      ...
      <div className="reveal-right relative h-[420px] md:h-[620px]">
        ...
        <FallbackImage
          ...
          alt="Khalid Wani"
          className="absolute right-0 top-0 object-cover object-top transition-transform duration-500 ease-in-out hover:scale-105"
        ...
        <FallbackImage
          ...
          className="absolute left-0 bottom-0 object-cover z-10 transition-transform duration-500 ease-in-out hover:scale-105"
          style={{
            width: "48%",
            height: "50%",
        ...
        {/* Chip badge */}
        <div className="absolute right-0 bottom-[90px] bg-gold text-ink text-[10px] font-medium tracking-[0.18em] uppercase px-7 py-4 z-20">
          KWCG · Director
        </div>
