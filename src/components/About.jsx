      ...
      <div className="mx-auto grid max-w-[1440px] items-center gap-14 lg:grid-cols-2 lg:gap-20">
        <div className="max-w-2xl">
          ...
          <div className="reveal delay-3 mt-10 flex flex-wrap items-center gap-4">
            <a
              href="#contact"
              className="inline-flex h-14 items-center justify-center rounded-full bg-[#B0E4CC]  px-8 text-[10px] font-bold uppercase tracking-[0.26em] text-[#07111f] transition duration-300 hover:-translate-y-0.5 hover:bg-[#B0E4CC] -light"
            >
              Work with Khalid
            </a>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <div className="grid gap-5">
            ...
            <div className="reveal delay-3 flex min-h-[220px] flex-col justify-between rounded-[28px] border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.03] p-6 backdrop-blur-xl md:min-h-[250px]">
              ...
              <div className="mt-6 inline-flex rounded-full bg-[#B0E4CC]  px-5 py-3 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#07111f]">
                KWCG / Director
              </div>
            </div>
          </div>
